...
public class ObjectUtil {
    ...
    public static SopObjectParameter getParameter(Class<?> type, UUID id, String key)
            throws MException {
        return M.l(AdbApi.class).getParameter(type, id, key);
    }

    public static void setParameter(Class<?> type, UUID id, String key, String value)
            throws MException {
    ...
    public static List<SopObjectParameter> getParameters(Class<?> type, String key, String value)
            throws MException {
        return M.l(AdbApi.class).getParameters(type, key, value);
    }

    public static String getRecursiveValue(
            Class<? extends DbMetadata> clazz, UUID id, String key, String def) throws MException {
