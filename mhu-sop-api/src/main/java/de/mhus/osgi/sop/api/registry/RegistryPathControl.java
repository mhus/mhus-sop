...
public interface RegistryPathControl {
    ...
    /**
     * Return true if the path is controlled by this controller. This is additional to checked to
     * the component parameter 'path'. If you not have any special rule to ignore control you can
    ...
    /**
     * The method can modify or deny setting of the parameter. If not implemented return the
     * incoming value.
     *
     * @param manager
     * @param value
    ...
    /**
     * The method can modify or deny local setting of the parameter. If not implemented return the
     * incoming value.
     *
     * @param manager
     * @param value
