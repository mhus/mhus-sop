...
public class MutableMailMessage {
	...
	public MutableMailMessage(String source, String from, String to, String cc, String bcc, String subject,
	...
	public MailMessage toMessage() {
		return new MailMessage(source, from, to, cc, bcc, subject, content, attachments, individual);
	}
