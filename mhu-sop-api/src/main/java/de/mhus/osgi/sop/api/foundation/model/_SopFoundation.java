...
public class _SopFoundation extends ConstBase {
  ...
  public static final Identifier CLASS_EXTENDS = new Identifier(Identifier.TYPE.CLASS, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"de.mhus.lib.adb.DbMetadata");
  public static final Identifier CLASS_NAME = new Identifier(Identifier.TYPE.CLASS, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"de.mhus.osgi.sop.api.foundation.model.SopFoundation");
  public static final Identifier CLASS_PATH = new Identifier(Identifier.TYPE.CLASS, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"de.mhus.osgi.sop.api.foundation.model.SopFoundation");
  public static final Identifier METHOD_CREATE = new Identifier(Identifier.TYPE.ACTION, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"create");
  public static final Identifier METHOD_DELETE = new Identifier(Identifier.TYPE.ACTION, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"delete");
  public static final Identifier METHOD_FIND_PARENT_OBJECT = new Identifier(Identifier.TYPE.ACTION, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"findParentObject");
  public static final Identifier METHOD_GET_CREATION_DATE = new Identifier(Identifier.TYPE.GETTER, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"getCreationDate");
  public static final Identifier METHOD_GET_DB_HANDLER = new Identifier(Identifier.TYPE.GETTER, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"getDbHandler");
  public static final Identifier METHOD_GET_GROUP = new Identifier(Identifier.TYPE.GETTER, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"getGroup");
  ...
  public static final Identifier METHOD_IS_ADB_MANAGED = new Identifier(Identifier.TYPE.GETTER, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"isAdbManaged");
  public static final Identifier METHOD_IS_ADB_PERSISTENT = new Identifier(Identifier.TYPE.GETTER, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"isAdbPersistent");
  public static final Identifier METHOD_LOG = new Identifier(Identifier.TYPE.ACTION, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"log");
  public static final Identifier METHOD_RELOAD = new Identifier(Identifier.TYPE.ACTION, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"reload");
  ...
  public static final Identifier PROJECT_VERSION = new Identifier(Identifier.TYPE.MAVEN, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"1.6.0-SNAPSHOT");
