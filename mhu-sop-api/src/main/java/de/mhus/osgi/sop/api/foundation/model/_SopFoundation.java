...
public class _SopFoundation extends ConstBase {
  ...
  public static final Identifier PROJECT_VERSION = new Identifier(Identifier.TYPE.MAVEN, de.mhus.osgi.sop.api.foundation.model.SopFoundation.class,"1.6.2-SNAPSHOT");
