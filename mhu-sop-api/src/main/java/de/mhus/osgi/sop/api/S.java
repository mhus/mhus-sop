...
public class S {
     ...
     */
    public static OperationResult e(OperationsSelector selector, IProperties properties)
            throws NotFoundException {
     ...
     * @throws NotFoundException
     */
    public static OperationResult e(Class<?> filter, IProperties properties, String... providedTags)
            throws NotFoundException {
     ...
     * @throws NotFoundException
     */
    public static OperationResult e(
     ...
     * @throws NotFoundException
     */
    public static List<OperationResult> eAll(
     ...
     * @throws NotFoundException
     */
    public static List<OperationResult> eAll(OperationsSelector selector, IProperties properties)
            throws NotFoundException {
