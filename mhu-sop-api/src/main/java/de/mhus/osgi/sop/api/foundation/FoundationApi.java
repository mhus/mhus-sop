...
public interface FoundationApi {
    ...
    SopJournal appendJournalEntry(
            UUID foundation, String queue, String event, Map<String, Object> data)
            throws MException;

    SopJournal appendJournalEntry(UUID foundation, String queue, String event, String... data)
            throws MException;

    List<SopJournal> getJournalEntries(
