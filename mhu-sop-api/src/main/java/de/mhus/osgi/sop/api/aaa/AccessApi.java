 ...
 * - A thread is marked with a access context, in this context the program is acting while executed
 * - By default the access context is Guest
 * - Using process() will change the current access context and release() fall back to the previous context
 * 
 * @author mikehummel
 *
 */
