...
public interface AdbApi extends SApi {
    ...
    SopActionTask createActionTask(
            String queue, String action, String target, String[] properties, boolean smart)
            throws MException;

    List<SopActionTask> getQueue(String queue, int max) throws MException;

    List<SopObjectParameter> getParameters(Class<?> type, UUID id) throws MException;
    ...
    void setParameter(Class<?> type, UUID id, String key, String value) throws MException;

    void setParameter(String type, UUID id, String key, String value) throws MException;

    SopObjectParameter getGlobalParameter(String key) throws MException;

    String getValue(String type, UUID id, String key, String def) throws MException;

    String getValue(Class<?> type, UUID id, String key, String def) throws MException;

    SopObjectParameter getParameter(String type, UUID id, String key) throws MException;

    SopObjectParameter getParameter(Class<?> type, UUID id, String key) throws MException;

    void deleteParameters(Class<?> type, UUID id) throws MException;

    List<SopObjectParameter> getParameters(Class<?> type, String key, String value)
            throws MException;
