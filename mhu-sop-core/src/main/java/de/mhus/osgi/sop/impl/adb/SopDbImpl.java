...
public class SopDbImpl extends AbstractDbSchemaService {
    ...
    ////			return ace.canRead();
    //
    //			return M.l(AccessApi.class).hasResourceAccess(account.getAccount(), type,
    // String.valueOf(o.getObjectId()), Account.ACT_READ, null);
    //		}
    ...
    //			return M.l(AccessApi.class).hasResourceAccess(account.getAccount(), type,
    // String.valueOf(o.getObjectId()), Account.ACT_UPDATE, null);
    //
    //		}
    //		return false;
    //	}
    ...
    //			return M.l(AccessApi.class).hasResourceAccess(account.getAccount(), type,
    // String.valueOf(o.getObjectId()), Account.ACT_DELETE, null);
    //		}
    //		return false;
    //	}
    ...
    //			return M.l(AccessApi.class).hasResourceAccess(account.getAccount(), type,
    // String.valueOf(o.getObjectId()), Account.ACT_CREATE, null);
    //		}
    //
    //		return false;
    //	}
