...
public class TryLdapAccount {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        //        DirContext ctx = MLdap.getConnection("ldap://localhost:11389", "cn=Directory
        // Manager", "nein");

        //        NamingEnumeration<SearchResult> res = ctx.search("ou=people,dc=ngnetwork,dc=de",
        // MLdap.FILTER_ALL_CLASSES,MLdap.getSimpleSearchControls());
        //        for (Map<String, Object> entry : MLdap.iterate(res)) {
        //            System.out.println(entry);
        //        }

        //      NamingEnumeration<SearchResult> res = ctx.search("ou=groups,dc=ngnetwork,dc=de",
        // MLdap.FILTER_ALL_CLASSES,MLdap.getSimpleSearchControls());
        //      for (Map<String, Object> entry : MLdap.iterate(res)) {
        //          System.out.println(entry);
        //      }
        ...
        //        NamingEnumeration<SearchResult> res = ctx.search("ou=people,dc=ngnetwork,dc=de",
        // "(uid=adm-hummel)",MLdap.getSimpleSearchControls());
        //        for (Map<String, Object> entry : MLdap.iterate(res)) {
        ...
        provider.setUserAttributeMapping(
                "firstName=Vorname;lastName=Nachname;company=Firma;email=Email;phone=telephoneNumber;language=Sprache;salutation=Anrede");
